...
(wstęgi boczne) oddalone o częstotliwość modulująca, około 20 Hz. Niewielkie różnice w odczytanych częstotliwościach
(np. 206 Hz zamiast 200 Hz) wynikają ze skończonej rozdzielczości prążków FFT w oscyloskopie.
